...
#define K_P_2    0.08 // P constant
#define K_I_2    0.2 // I constant
#define K_D_2    0.2 // D constant
#else
/*
#define K_P    10.25/16     // P constant
#define K_I    33.42/16     // I constant
#define K_D    20.34/16     // D constant

#define K_P_2    10.25/16   // P constant
#define K_I_2    33.42/16   // I constant
#define K_D_2    20.34/16   // D constant
*/

#define K_P    1.025   // P constant
#define K_I    3.342   // I constant
#define K_D    2.034  // D constant

#define K_P_2    1.025   // P constant
#define K_I_2    3.342   // I constant
#define K_D_2    2.034   // D constant
...
//#define COUNTS_PER_REV  1950//1560 //wheel encoder's no of ticks per rev(gear_ratio * pulse_per_rev)
//#define WHEEL_DIAMETER  0.053 //wheel's diameter in meters

//#define BASE_WIDTH 0.281


#define WHEEL_DIAMETER  0.082 //wheel's diameter in meters

//#define BASE_WIDTH 0.216
#define BASE_WIDTH 0.376
//#define COUNTS_PER_REV  1950 // 650
// #define COUNTS_PER_REV   3690
#define COUNTS_PER_REV   1380
...
#define MOTORn						2
#define RIKI_MOTOR1_A_PIN           GPIO_Pin_12
#define RIKI_MOTOR1_B_PIN           GPIO_Pin_11
#define RIKI_MOTOR1_GPIO_PORT       GPIOA
#define RIKI_MOTOR1_GPIO_CLK        RCC_APB2Periph_GPIOA

#define RIKI_MOTOR2_A_PIN           GPIO_Pin_8
#define RIKI_MOTOR2_B_PIN           GPIO_Pin_7
#define RIKI_MOTOR2_GPIO_PORT       GPIOC
#define RIKI_MOTOR2_GPIO_CLK        RCC_APB2Periph_GPIOC

#define RIKI_MOTOR1_PWM_PIN         GPIO_Pin_0
...
#define RIKI_MOTOR2_PWM_PIN         GPIO_Pin_1
